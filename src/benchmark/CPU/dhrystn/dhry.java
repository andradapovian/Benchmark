package benchmark.CPU.dhrystn;

import benchmark.IBenchmark;

public class dhry  extends GlobalVariables implements IBenchmark{

	private long Number_Of_Runs;
	private long time;
	...
	public void initialize(Object... params) {
		this.Number_Of_Runs = (long) params[0];
	...
	public String getResult() {
		...
		return "Result: " + Number_Of_Runs * 1000 / this.getTime() + " dhrystone/sec.";
	}
